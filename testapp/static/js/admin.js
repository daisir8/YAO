...
function insert_medicine() {
    ...
    var url = "/login/open_insert_medicine";
...
function insert_warehouse() {
    ...
    var url = "/login/open_insert_warehouse";
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}
...
function insert_manu() {
    ...
    var url = "/login/open_insert_manu";
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}

//插入的js代码模板
function insert_churu() {
    var xmlhttp;
    if (window.XMLHttpRequest) {
        //  IE7+, Firefox, Chrome, Opera, Safari 浏览器执行代码
        xmlhttp = new XMLHttpRequest();
    ...
    var url = "/login/open_insert_churu";
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}
...
function delete_medicine() {
    ...
    var url = "/login/open_delete_medicine";
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}
...
function delete_warehouse() {
    ...
    var url = "/login/open_delete_warehouse";
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}
...
function delete_manu() {
    ...
    var url = "/login/open_delete_manu;
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}
...
function delete_churu() {
    ...
    var url = "/login/open_delete_churu";
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}

//修改的js代码模板
function alter_medicine() {
    var xmlhttp;
    if (window.XMLHttpRequest) {
        //  IE7+, Firefox, Chrome, Opera, Safari 浏览器执行代码
        xmlhttp = new XMLHttpRequest();
    ...
    var url = "/login/open_alter_medicine";
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}

//修改的js代码模板
function alter_warehouse() {
    var xmlhttp;
    if (window.XMLHttpRequest) {
        //  IE7+, Firefox, Chrome, Opera, Safari 浏览器执行代码
        xmlhttp = new XMLHttpRequest();
    ...
    var url = "/login/open_alter_warehouse";
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}
...
function alter_manu() {
    ...
    var url = "/login/open_alter_manu";
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}

//修改的js代码模板
function alter_churu() {
    var xmlhttp;
    if (window.XMLHttpRequest) {
        //  IE7+, Firefox, Chrome, Opera, Safari 浏览器执行代码
        xmlhttp = new XMLHttpRequest();
    ...
    var url = "/login/open_alter_churu";
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}
...
function medicine_show() {
    ...
    var url = "/login/medicine_show";
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}

//查询的js代码模板
function admin1_show() {
    var xmlhttp;
    if (window.XMLHttpRequest) {
        //  IE7+, Firefox, Chrome, Opera, Safari 浏览器执行代码
        xmlhttp = new XMLHttpRequest();
    ...
    var url = "/login/admin1_show";
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}

//查询的js代码模板
function warehouse_show() {
    var xmlhttp;
    if (window.XMLHttpRequest) {
        //  IE7+, Firefox, Chrome, Opera, Safari 浏览器执行代码
        xmlhttp = new XMLHttpRequest();
